...
/*
1. option to send response or call the next middleware
2. option to allow undefined paths
3. option to specify the HTTP code in validation failed responses
3. init()->constructor(), allow creation of multiple objects, then we can use the middleware in router level
*/
