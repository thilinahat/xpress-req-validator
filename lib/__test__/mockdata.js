...
export const USER_INFO_PATH_PATTERN = '/user/:id/info';
export const USER_FRIENDS_PATH_PATTERN = '/user/:id/friends';
export const USER_PATH_PATTERN = '/user';
export const USER_AUTHENTICATE_PATH_PATTERN = '/user/authenticate';
export const UNDEFINED_PATH_PATTERN = '/unknow/path';
